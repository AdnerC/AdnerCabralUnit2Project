...
public class EquationRunner {
    public static void main(String[] args) {
        ...
        String y1S = firstString.substring(index1+1, firstString.length()-1);

        String x2S = secondString.substring(1, index1);
        String y2S = secondString.substring(index2+1, secondString.length()-1);
